...
$diccionario = array(
    ...
    'form_actions'=>array(
        'SET'=>'/api.model3d.com/repositoriopagina.mvc/'.MODULO.SET_USER.'/',
        'GET'=>'/api.model3d.com/repositoriopagina.mvc/'.MODULO.GET_USER.'/',
        'DELETE'=>'/api.model3d.com/repositoriopagina.mvc/'.MODULO.DELETE_USER.'/',
        'EDIT'=>'/api.model3d.com/repositoriopagina.mvc/'.MODULO.EDIT_USER.'/'
    )
); 
