...
class editarrepositorio {
    ...
    public static function editarepositorio() {
        ...
        if (self::actualizarRepo( $id_cuenta, $nombre_rep, $id_repositorio, $repositorio ) > 0) {
    ...
    private function actualizarRepo( $id_cuenta, $id_repositorio, $nombre_rep, $repositorio ) {
        try {
            // Creando consulta UPDATE
            $consulta = "UPDATE " . self::NOMBRE_TABLA .
                " SET " . self::REPOSITORIO_NOMBRE . "=?" .
            ...
            $sentencia->bindParam(3, $id_repositorio);
