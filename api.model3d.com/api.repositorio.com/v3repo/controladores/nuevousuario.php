...
class nuevousuario {
    ...
    public function registrarusuario($nombre,$apellido,$fecha_na,$correo,$password,$estado)
    {
        ...
        //$contenido = [$nombre,$apellido,$fecha_na,$correo,$password,$estado];
/*
        $contenido = array("nombre"=>$nombre, "apellido"=>$apellido,   
                  "fecha_na"=>$fecha_na, "correo"=>$correo,   
                  "estado"=>$estado);  
    */
        $idContacto = nuevousuario::crear($nombre,$apellido,$fecha_na,$correo,$password,$estado);
        
        //$data = implode( ", ", $idContacto );
    ...
    private function crear($nombre,$apellido,$fecha_na,$correo,$password,$estado) {
        //if ($contenido) {
            try {
