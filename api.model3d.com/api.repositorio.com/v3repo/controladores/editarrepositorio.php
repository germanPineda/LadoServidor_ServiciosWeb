...
*/
    public function editarepositorio( $nombre_rep, $id_tiporepositorio, $id_repositorio, $id_cuenta) {
        ...
        //$repositorio = [$id_cuenta, $nombre_rep, $id_repositorio, $id_tiporepositorio];

        self::actualizarRepo( $nombre_rep, $id_tiporepositorio, $id_repositorio, $id_cuenta); 
    ...
    private function actualizarRepo(  $nombre_rep, $id_tiporepositorio, $id_repositorio, $id_cuenta ) {
        try {
