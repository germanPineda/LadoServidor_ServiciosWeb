...
/*
    ...
    public static function obtenerinfo($correo) {
        ...
        if ($correo!=null) {
            ...
            if ($usuarioBD != NULL) {
                ...
                return "Id de la cuenta: " . $respuesta["id_cuenta"] . " | Nombre completo del propietario: " . $respuesta["nombre"] . " " . $respuesta["apellido"];
            } else {
