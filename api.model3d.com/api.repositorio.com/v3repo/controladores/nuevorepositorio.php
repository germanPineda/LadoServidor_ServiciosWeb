...
*/
    public static function registrarrepositorio($nombre_rep,$id_tiporepositorio,$id_cuenta,$fecha_ceacion)
    {/*
        $body = file_get_contents('php://input');
        $repositorio = json_decode($body);
        $repositorio = [$nombre_rep,$id_tiporepositorio,$id_cuenta,$fecha_ceacion];*/
        $resultado = nuevorepositorio::crearrepositorio($nombre_rep,$id_tiporepositorio,$id_cuenta,$fecha_ceacion);
    
        //http_response_code(201);
        return "creo que funciona";/*[
    ...
    private function crearrepositorio($nombre_rep,$id_tiporepositorio,$id_cuenta,$fecha_ceacion) {
        //if ($contenido) {
            try {
